...
#             msg.linear_acceleration_covariance[i]=message['linear_acceleration_covariance'][i]
            self._rosPub=rospy.Publisher(self._local_topic_name, Status, queue_size=10)
...
if __name__ == '__main__':
    a=ROSCloudSubBridge(ip='83.212.96.15', port="8018", local_topic_name="/local/robot/mobile_base_nodelet_manager/bond",remote_topic_name="/mobile_base_nodelet_manager/bond", message_type="bond/Status")
    a.start()
