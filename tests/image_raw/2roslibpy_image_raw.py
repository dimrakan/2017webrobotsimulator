...
if __name__ == '__main__':
    a=ROSCloudSubBridge(ip='83.212.96.15', port="8018", local_topic_name="/local/robot/camera/rgb/image_raw",remote_topic_name="/camera/rgb/image_raw", message_type="sensor_msgs/Image")
    a.start()
